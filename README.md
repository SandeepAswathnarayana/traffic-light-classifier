...
**NOTE: This is the first classifier I built as a part of Udacity's Sytem Integration project. Later, I developed and built another classifier using Faster RCNN which performed relatively well on our traffic light dataset.**  
